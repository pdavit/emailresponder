...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <SignedIn>
        <div className="flex items-center justify-center min-h-screen">
          <div className="text-center">
            <h1 className="text-6xl font-bold text-gray-900 dark:text-white mb-4">EmailResponder</h1>
            ...
            {/* Trial promo */}
            <section className="bg-gray-100 dark:bg-gray-800 py-16 mt-12">
      ...
      <SignedOut>
        <div className="flex flex-col md:flex-row min-h-screen items-center justify-evenly">
          <div className="w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
            <SignIn />
          </div>
          <div className="w-full max-w-md p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg mt-10 md:mt-0">
            <SignUp />
          </div>
        </div>
      </SignedOut>
